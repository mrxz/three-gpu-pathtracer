...
`}),h("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["cFRYa","overlay.7dd7fe25.js","512E4","parallelMeshBVH.worker.22cf4bb0.js","9P1cE","generateMeshBVH.worker.cd4b9fc6.js","lWWke","generateMeshBVH.worker.373f3c58.js","9P1cE","generateMeshBVH.worker.cd4b9fc6.js","jwbL2","aoRender.e5303912.js","63CMm","aoRender.a1271ff5.js","2tzBs","aoRender.89c1b67b.js","6UuCC","aoRender.5fc59dbe.js","6mMEU","aoRender.fc8349f1.js","i0zVc","aoRender.dcf40b33.js","j19h5","aoRender.e8b1599c.js","5lTJX","areaLight.1c24b9b9.js","eif6c","areaLight.5654e8b2.js"]'));var f=h("ilwiq"),m=h("5Rd1x"),g=h("8mHfG"),w=h("891vQ"),v=h("jiuw3"),b=h("7lx9d"),x=h("kp7Te"),y=h("kqOCM"),B=h("cE5k3"),T=h("e2Pv4");const M={bounces:5,renderScale:1/window.devicePixelRatio,filterGlossyFactor:.5,tiles:1,multipleImportanceSampling:!0,enabled:!0,...(0,B.getScaledSettings)()};function P(){e.filterGlossyFactor=M.filterGlossyFactor,e.bounces=M.bounces,e.renderScale=M.renderScale,e.multipleImportanceSampling=M.multipleImportanceSampling}function k(){t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(window.devicePixelRatio),o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),e.updateCamera()}!async function(){(s=new T.LoaderElement).attach(document.body),(t=new f.WebGLRenderer({antialias:!0})).toneMapping=f.ACESFilmicToneMapping,document.body.appendChild(t.domElement),(e=new g.WebGLPathTracer(t)).tiles.set(M.tiles,M.tiles),e.setBVHWorker(new y.ParallelMeshBVHWorker),(o=new f.PerspectiveCamera(75,window.innerWidth/window.innerHeight,.025,500)).position.set(2.996,3.795,.697),(r=new m.OrbitControls(o,t.domElement)).target.set(.311,1.13,.489),r.addEventListener("change",()=>e.updateCamera()),r.update(),a=new f.Scene,n=new f.Scene;let[l,c]=await Promise.all([new(0,w.RGBELoader)().loadAsync("https://raw.githubusercontent.com/mrdoob/three.js/dev/examples/textures/equirectangular/royal_esplanade_1k.hdr"),new(0,b.GLTFLoader)().setMeshoptDecoder(x.MeshoptDecoder).loadAsync("https://raw.githubusercontent.com/gkjohnson/3d-demo-data/main/models/sd-macross-city-standoff-diorama/scene.glb")]);l.mapping=f.EquirectangularReflectionMapping,a.background=l,a.environment=l;let d=new f.Box3;c.scene.traverse(e=>{e.material&&(e.material.map=null)}),c.scene.updateMatrixWorld(!0),d.setFromObject(c.scene),c.scene.position.y-=d.min.y,a.add(c.scene);let u=new f.CylinderGeometry(3.5,3.5,.05,60),h=new f.MeshStandardMaterial({color:new f.Color(10066329),metalness:.2,roughness:.02}),p=new f.Mesh(u,h);p.position.y=-.025,a.add(p),i=[];let B=new f.Mesh(new f.CylinderGeometry(.5,.5,.5,32),new f.MeshBasicMaterial({color:16711680})),S=new f.Mesh(new f.BoxGeometry(.3,.3,.3),new f.MeshBasicMaterial({color:65280}));B.position.set(-1,0,1),S.position.set(1,0,-1),i.push(B,S),n.add(B,S),await e.setSceneAsync(a,o,{onProgress:e=>{s.setPercentage(e)}}),s.setCredits("Model by tipatat on Sketchfab");let C=new v.GUI().addFolder("Path Tracer");C.add(M,"tiles",1,4,1).onChange(t=>{e.tiles.set(t,t)}),C.add(M,"filterGlossyFactor",0,1).onChange(P),C.add(M,"bounces",1,15,1).onChange(P),C.add(M,"renderScale",.1,1).onChange(P),C.add(M,"multipleImportanceSampling").onChange(P),C.close(),P(),k(),window.addEventListener("resize",k),function r(){requestAnimationFrame(r),function(){for(let e=0;e<i.length;e++)i[e].position.y=Math.sin(.001*Date.now()+e)}(),e.renderSample();let l=t.autoClear;t.autoClear=!1,a.overrideMaterial=E,t.clearDepth(),t.render(a,o),a.overrideMaterial=null,t.render(n,o),t.autoClear=l,s.setSamples(e.samples,e.isCompiling)}()}();const E=new f.MeshBasicMaterial({colorWrite:!1});
//# sourceMappingURL=overlay.7dd7fe25.js.map
